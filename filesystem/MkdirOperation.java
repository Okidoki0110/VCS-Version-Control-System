...
public final class MkdirOperation extends FileSystemOperation {
    ...
    public int execute(FileSystemSnapshot fileSystemSnapshot) {
        ...
        result = fileSystemSnapshot.addEntity(EntityType.DIRECTORY,
                operationArgs.get(0), operationArgs.get(1));
        return result;
    }

    @Override
    public String description() {
        String message = String.format("\tCreated directory %s", operationArgs.get(1));
        return message;
    }
